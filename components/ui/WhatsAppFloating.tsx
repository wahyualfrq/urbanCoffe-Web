...
export const WhatsAppFloating = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show button only after scrolling down 400px (past Hero section)
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div 
          ...
          className="fixed bottom-6 right-6 z-[99] flex items-center group"
        >
          ...
          <Link 
            ...
            className="bg-[#25D366] text-white p-4 rounded-full shadow-premium-lg hover:shadow-glass hover:-translate-y-2 transition-all duration-300 relative flex items-center justify-center active:scale-90 animate-float-slow"
